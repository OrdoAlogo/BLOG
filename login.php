        ...
        <div class="sesion">
            ...
            <form id="Login" action="" method="$_GET">
                ...
                <label for="Nick">Nickname
                    ...
                    <input type="text" name="Nick" class="camposTx" id="Nick"><br>
                </label></br>
                
                <label for="Contra"> Contraseña
                    </br>
                    <input type="password" name="Contra" class="camposTx"><br>
           ...
           <!--  <form id="Registro" action="" method="post" enctype="multipart/form-data">
            ...
            <aside>
                ...
                <label for="Nick">Nickname
                            ...
                            <input type="text" id="nick" name="nick" class="camposTx"><br>
                            <p id="nickExiste" class="existe"> El nick ya existe</p>
                        </label></br>
                        <label for="mail">Email
                            </br>
                            <input type="text"  id="email" name="email" class="camposTx"><br>
                            <p id="emailExiste"class="existe"> El email ya existe</p>
                        </label></br>
                    
                        <label for="Contra"> Contraseña
                            </br>
                            <input type="password" id="contra" class="camposTx" name="contra" onkeydown="longContrasenia()" onkeyup="longContrasenia()"><br>
                        </label><br>
                        <label for="Arch"> Archivo</label><br>
                        <input type="file" id="arch" name="arch"><br>
